...
!\[Project Files](screenshots/1\_all%20files.png)
...
The aim was to create a basic `asm\_main` function in Assembly to perform arithmetic operations (adding 10 + 20) and return the integer result to a C driver. This established the foundational link between the two languages.
...
\* \*\*Task 1 Code (Basic):\*\* `t1\_code.png`

\* \*\*Task 1.2 Code (Variables):\*\* `t1\_2\_code.png`



!\[Task 1 Code](screenshots/t1\_code.png)

!\[Task 1.2 Code](screenshots/t1\_2\_code.png)
...
!\[Task 1 Output](screenshots/output\_t1andt1\_2.png)
...
!\[Loop Logic](screenshots/t2\_code.png)
...
!\[Task 2 Output](screenshots/output\_t2.png)
...
!\[Array Sum Code](screenshots/t2\_array\_code.png)

!\[Range Sum Code](screenshots/t2\_range\_code.png)
...
!\[Range Sum Output](screenshots/output\_t2\_range\_and\_input.png)
...
!\[Makefile Script](screenshots/t3\_code.png)
